                ...
                <div class="dropdown ms-2 ">
                    ...
                    <div class="dropdown-menu p-3" aria-labelledby="dropdownMenuButton" style="min-width: 350px;">
                        ...
                        <form id="addRecycledResource" class="ps-4 mt-2">
                            ...
                            <button type="submit" id="btnAddRecycledResourceSubmit"
                                class="btn btn-primary ms-4">Agregar</button>
                            <button type="button" class="btn btn-danger" onclick="reporteRecursosReciclaje()"><i
