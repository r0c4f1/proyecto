      ...
      <form id="formAddIncidentAssignment">
        ...
        <div class="modal-body">
          ...
          <div class="row p-3">
            ...
            <label class="col-12 mb-3 text-primary">
              Estado
              <input type="text" name="estado" id="estado" value="Pendiente" placeholder="Pendiente" class="form-control" readonly required>
            </label>
            ...
            <div id="container" class="input-group mt-2">
              ...
              <div class="col-5 ms-2">
                <label>
                  Cantidad
                  <input type="number" name="cantidad1" id="cantRecurso" class="form-control" disabled required>
                </label>
              </div>
            </div>
        ...
        <div class="modal-footer d-flex aling-content-center justify-content-center">
          <button type="button" class="btn btn-secondary" id="btnCloseAddIncidentAssignment" data-bs-dismiss="modal">Cerrar</button>
          <button type="submit" class="btn btn-success" id="btnGuardarIncidentAssignment" disabled>Guardar</button>
        </div>
      </form>
    </div>
  </div>
            ...
            <div class="modal-header bg-primary text-white">
                ...
                <div class="modal-body">
                    ...
                    <label for="estado" class="col-12 mb-4">Tipo De Incidencia:
                        ...
                        <label class="col-6">
                            Reportado Por
                            <input type="number" name="reportado_por"  class="form-control" value="<?= $_SESSION['id_usuario'] ?>">
                        </label>
                    </div>
                </div>
            ...
            <form id="formEditIncident">
                ...
                <div class="modal-body">
                    ...
                    <label for="estado" class="col-12 mb-4">Tipo De Incidencia:
                        ...
                        <label class="col-6 mb-4">
                            Categoria
                            <input type="text" name="categoria" id="categoriaEdit" class="form-control" value="" readonly>
                        </label>
                        <label class="col-6">
                            Fecha de Inicio
                            <input type="date" name="fecha_reporte" id="fecha_reporte" class="form-control">
                        ...
                        <label class="col-12 mb-4">
                            Descripción
                            <div class="form-floating">
                                <textarea class="form-control" name="descripcion" style="height: 100px" value="<? $_SESSION["nombres"]?>"></textarea>
                            </div>
                        </label>
                        <label class="col-6">
                            Reportado Por
...
<div class="modal fade" id="modalViewUser" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column" style="min-height: 300px;"> <!-- Asegura una altura mínima -->
