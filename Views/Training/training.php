...
<main class="main">
        ...
        <section >
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="col-5 d-flex justify-content-between">
                    <input
                        type="text" class="mt-4 form-control w-50" placeholder="Buscar" onkeyup="filtroListaInscritos(event)" id="buscador" disabled>
   ...
   <button class="btn btn-primary mt-4" onclick="inscribirTodos()" disabled id="btnInscribirseTodos" style="<?php echo $nivelUsuario == 0 ? 'display:none;' : ''; ?>">
                        Inscribir a Todos
                    </button>
        ...
        <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" disabled>
...
<hr>
            <article class="container col-12 mt-2 inscritos row flex-wrap justify-content-start align-items-start" id="listaInscritos"
