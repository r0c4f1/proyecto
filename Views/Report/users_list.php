...
<body>
    ...
    <div class="content">
        <div class="title-container">
            <h2>Reporte de Empleados de la Oficina de Tecnologías de Información y Comunicación</h2>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td style="width:15%"><?= $data['datos'][$i]['id_usuario']; ?></td>
                    <td style="width:20%"><?= $data['datos'][$i]['nombres']; ?></td>
                    <td style="width:20%"><?= $data['datos'][$i]['apellidos']; ?></td>
                    <td style="width:30%"><?= $data['datos'][$i]['email']; ?></td>
                    <td style="width:15%"><?= $data['datos'][$i]['cargo']; ?></td>
