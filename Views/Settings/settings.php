            ...
            <div class="card w-100">
                ...
                <div class="card-body">
                    <div class="upload-container">
                        <input class="form-control border rounded w-100" type="file" id="fileInput"
                            accept=".jpg,image/jpeg">
                        <button class="btn btn-primary" id="uploadButton"><i class="fas fa-upload"></i> Subir
                            Imagen</button>
                    </div>
                </div>
            </div>
    ...
    <div class="d-flex justify-content-between">
        <section class="card-container col-6">
            ...
            <div class="card w-100">
                ...
                <div class="card-body">
                    <div class="upload-container">
                        <input class="form-control border rounded w-100" type="file" id="fileInput2"
                            accept=".jpg,image/jpeg,.png,image/png">
                        <button class="btn btn-primary" id="uploadButtonSeal"><i class="fas fa-upload"></i> Subir
                            Imagen</button>
                    </div>
                </div>
            </div>
        ...
        <section class="card-container col-6 mx-2">
            ...
            <div class="card w-100">
                ...
                <div class="card-body">
                    <div class="upload-container">
                        <input class="form-control border rounded w-100" type="file" id="fileInput3"
                            accept=".jpg,image/jpeg,.png,image/png">
                        <button class="btn btn-primary" id="uploadButtonFirm"><i class="fas fa-upload"></i> Subir
                            Imagen</button>
                    </div>
                </div>
            </div>
