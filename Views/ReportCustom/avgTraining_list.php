...
<body>
    ...
    <div class="content">
        <div class="title-container">
            <h2>Informe de capacitaciones realizadas anualmente</h2>
            <h2>Uso Interno OTIC</h2>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    <th>Tema</th>
                    <th>N.º de Participantes</th>
                    <th>Porcentaje Representativo
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td><?= $data['datos'][$i]['tema']; ?></td>
                    <td><?= $data['datos'][$i]['total_participantes_por_curso']; ?></td>
                    <td><?= $data['datos'][$i]['porcentaje']; ?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
